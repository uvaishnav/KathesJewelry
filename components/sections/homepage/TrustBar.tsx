...
const PILLARS: TrustPillar[] = [
  {
    icon: Building2,
    value: 'Since 1993',
    label: 'Over 30 years serving New York City',
  },
  {
    icon: Award,
    value: 'GIA-Certified',
    label: 'In-house expertise on every piece we touch',
  },
  {
    icon: Star,
    value: 'Rated 4.8 Stars',
    label: 'Across Google, Yelp & TrustAnalytica',
  },
  {
    icon: Wrench,
    value: 'All Repairs In-House',
    label: 'Your jewelry never leaves our workshop',
  },
]
...
export function TrustBar() {
  return (
    ...
    >
      ...
      <div className="py-14 px-[var(--container-padding)]">
        <div
          className="mx-auto"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x-0 lg:divide-x divide-[var(--gold-primary)]/15 gap-y-10 lg:gap-y-0">
            {PILLARS.map((pillar, i) => {
              ...
              return (
                ...
                >
                  {/* Icon — gold circle ring */}
                  <div
                    className="relative flex items-center justify-center w-14 h-14 mb-4"
                    aria-hidden="true"
                  >
                    {/* Outer ring */}
                  ...
                  {/* Value */}
                  <p className="font-sans text-[16px] font-bold text-white leading-tight mb-2">
                    {pillar.value}
                  </p>

                  {/* Label */}
                  <p className="font-body text-[13px] text-[var(--text-muted)] leading-snug max-w-[150px] italic">
                    {pillar.label}
                  </p>
                </ScrollReveal>
              )
