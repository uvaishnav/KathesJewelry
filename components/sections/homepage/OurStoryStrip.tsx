...
export function OurStoryStrip() {
  return (
    <section
      className="py-[var(--section-padding)] px-[var(--container-padding)] relative overflow-hidden"
      style={{
        backgroundColor: 'var(--warm-cream)',
        backgroundImage: [
          'radial-gradient(ellipse at 105% 0%, rgba(201,169,110,0.09) 0%, transparent 42%)',
          'radial-gradient(ellipse at -8% 100%, rgba(201,169,110,0.06) 0%, transparent 40%)',
        ].join(', '),
      }}
      ...
      >
        ...
        <ScrollReveal direction="left">
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            <span
              className="absolute border-t border-r border-[var(--gold-primary)]/40"
              style={{ top: 0, right: 0, width: 32, height: 32 }}
              aria-hidden="true"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="right" delay={0.1}>
          ...
          <blockquote className="relative mb-8 pl-6">
            ...
            />
            <span
              className="absolute font-serif text-[80px] leading-none select-none"
              style={{ top: -12, left: -4, color: 'rgba(201,169,110,0.2)' }}
              aria-hidden="true"
            >
              &ldquo;
            </span>
          ...
          <div className="flex items-center gap-6 flex-wrap">
            <Button variant="primary" href="/about-us">Meet the Full Family</Button>
            <p className="font-body italic" style={{ fontSize: 13, color: 'var(--text-muted)' }}>
